    ...
    <div class="row g-4">
        <div class="col-lg-4">
            <div class="card text-center p-4 h-100">
                ...
                <h4 class="fw-bold mb-1">${lecturer.fullName}</h4>
        ...
        <div class="col-lg-8">
            <div class="card p-4 h-100">
                ...
                <div class="row gy-4">
                    <div class="col-md-6">
                        <label class="text-muted small d-block">Mã số giảng viên (MSCV)</label>
                        <span class="fw-bold">${lecturer.mscv}</span>
                    </div>
                    <div class="col-md-6">
                        <label class="text-muted small d-block">Học hàm/học vị</label>
                        <span class="fw-bold">${lecturer.academicTitle}</span>
                    </div>
                    <div class="col-md-6">
                        <label class="text-muted small d-block">Lĩnh vực nghiên cứu</label>
                        <span class="fw-bold">${lecturer.researchField}</span>
                    </div>                    
                    <div class="col-md-6">
                        <label class="text-muted small d-block">Địa chỉ Email</label>
                        <span class="fw-bold">${lecturer.email}</span>
                    </div>               
                </div>
            </div>
        </div>
...
<div class="modal fade" id="editProfileModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content border-0 shadow">
            <form action="${pageContext.request.contextPath}/lecturer/profile/update" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="academicTitle" class="form-control" value="${lecturer.academicTitle}" required>
                    </div>   
                    <div class="mb-3">
                        <label class="form-label fw-bold">Lĩnh vực nghiên cứu</label>
                        <input type="text" name="researchField" class="form-control" value="${lecturer.researchField}" required>
                    </div>   
    ...
    <div class="modal-dialog modal-sm modal-dialog-centered">
        <div class="modal-content border-0 shadow">
            <div class="modal-body text-center p-4">
                ...
                <form action="${pageContext.request.contextPath}/lecturer/profile/deactivate" method="POST">
                    <button type="button" class="btn btn-light" data-bs-dismiss="modal">Hủy</button>
