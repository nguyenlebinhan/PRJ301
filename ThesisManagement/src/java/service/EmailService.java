...
public class EmailService {
    ...
    private final String HOST = config.getProperty("email.host", "smtp.gmail.com");
    private final String PORT = config.getProperty("email.port", "587");
    private final String FROM_EMAIL = config.getProperty("email.from");
    private final String APP_PASSWORD = config.getProperty("email.app_password");
